...
del hw1.lst	REM hw1可以替換成.asm檔的檔名
del hw1.obj
del hw1.ilk
del hw1.pdb
del hw1.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:hw1.exe hw1.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
