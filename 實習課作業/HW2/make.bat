...
del group36_v1.lst	REM group36_v1可以替換成.asm檔的檔名
del group36_v1.obj
del group36_v1.ilk
del group36_v1.pdb
del group36_v1.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:group36_v1.exe group36_v1.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
