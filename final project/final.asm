...
main          EQU start@0
.data
titleStr BYTE "Zombie Hunter",0 ;標題名稱
a1 byte "                                                                       |  vvvvv                    |",0
a2 byte "                                                                       | |O o O|                   |",0
a3 byte "                                                                       | | +++ |                   |",0
a4 byte "                                                                       |  /###\                    |",0
...
msa byte "   ZZZZZZZZZZZZZZZZZ      OOOOOOOO       MMM      MM      MMM   BBBBBBBBBBBB    IIIIIIIIIII   EEEEEEEEEEEE    *  (1) Press |  A  | to hit left zombies      *",0
msb byte "                                                                                                              *            |_____|                          *",0
...
msf byte "   HHH         HHH    UUU         UUU    NNN NNN    NNN         TTT         EEE              RRR      RRR     *  (2) Press |  S  | to hit middle zombies    *",0
...
msk byte "   HHH         HHH     UUUUUUUUUUUUU     NNN      NNNNN         TTT         EEEEEEEEEEEEE    RRR     RRRR     *  (3) Press |  D  | to hit right zombies     *",0
msl byte "   HHH         HHH      UUUUUUUUUUU      NNN       NNNN         TTT         EEEEEEEEEEEEE    RRR      RRRR    *            |_____|                          *",0
msm byte "                                                                                                              *                                             *",0
msn byte "                                                                                                              *                                             *",0
mso byte "                                                                                                              * * * * * * * * * * * * * * * * * * * * * * * *",0
msp byte "                                                                                                                                             vvvvv",0
msq byte "   PPPPPP                                      ____________                                                                          vvvvv  |O o O|",0
mss byte "   PP   PP                                   /|            |\     TT                           TT                        TT         |O o O| | +++ |  vvvvv",0
mst byte "   PP   PP R   RRR  EEEEE   SSSSSS  SSSSSS  / |  ZZZZZZZZ  | \  TTTTTT    OOOOOO      SSSSSS TTTTTT    AAAAA   R   RRR TTTTTT       | +++ |  /***\  |O o O|",0
msu byte "   PPPPPP  R RRR   E     E S       S        | |       ZZ   | |    TT     OO    OO    S         TT     AA   AA  R RRR     TT          /***\          | +++ |",0
msv byte "   PP      RRR     EEEEEE   SSSSS   SSSSS   | |     ZZ     | |    TT     OO    OO     SSSSS    TT     AA   AA  RRR       TT             vvvvv        /***\",0
msw byte "   PP      RR      E             S       S  | |   ZZ       | |    TT  TT OO    OO          S   TT  TT AA   AA  RR        TT  TT        |O o O|  vvvvv",0
msx byte "   PP      RR       EEEEE  SSSSSS  SSSSSS   | |  ZZZZZZZZ  | |     TTTT   OOOOOO     SSSSSs     TTTT   AAAA AA RR         TTTT         | +++ | |O o O| vvvvv",0
msy byte "                                            | |____________| |                                                                   vvvvv  /***\  | +++ ||O o O|",0
msz byte "                                            | /            \ |                                                                  |O o O|   vvvvv /***\ | +++ |",0
ms0 byte "                                            |/______________\|                                                                  | +++ |  |O o O|       /***\",0
ms1000 byte "                                                                                                                                 /***\   | +++ |",0
ms1111 byte "                                                                                                                                          /***\",0
